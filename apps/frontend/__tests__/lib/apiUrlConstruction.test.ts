...
describe('API URL construction (#406)', () => {
  ...
  it.each([
    ...
    ['jumpToPosition', (s: HistoryService) => s.jumpToPosition('ds-1', 2, 'tok'), '/api/v1/transformations/datasets/ds-1/history/jump'],
    ['clearHistory', (s: HistoryService) => s.clearHistory('ds-1', 'tok'), '/api/v1/transformations/datasets/ds-1/history'],
