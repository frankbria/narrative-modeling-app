...
def create_mock_user_data(**kwargs):
    ...
    mock_data.file_path = "s3://test-bucket/test-file-123.csv"  # Add for backward compatibility
...
class TestDataProcessingAPI:
    ...
    @pytest.mark.asyncio
    async def test_process_dataset_success(self, async_test_client: AsyncClient, setup_database, sample_dataframe):
    ...
    @pytest.mark.asyncio
    async def test_process_dataset_not_found(self, async_test_client: AsyncClient, setup_database):
    ...
    @pytest.mark.asyncio
    async def test_get_schema_success(self, async_test_client: AsyncClient, setup_database):
        ...
        with patch('app.models.user_data.UserData.find_one', new_callable=AsyncMock) as mock_find:
            ...
            response = await async_test_client.get("/api/v1/data/test-file-123/schema")
    ...
    @pytest.mark.asyncio
    async def test_get_statistics_success(self, async_test_client: AsyncClient, setup_database):
        ...
        with patch('app.models.user_data.UserData.find_one', new_callable=AsyncMock) as mock_find:
            ...
            response = await async_test_client.get("/api/v1/data/test-file-123/statistics")
    ...
    @pytest.mark.asyncio
    async def test_get_quality_report_success(self, async_test_client: AsyncClient, setup_database):
        ...
        with patch('app.models.user_data.UserData.find_one', new_callable=AsyncMock) as mock_find:
            ...
            response = await async_test_client.get("/api/v1/data/test-file-123/quality")
    ...
    @pytest.mark.asyncio
    async def test_get_data_preview_success(self, async_test_client: AsyncClient, setup_database, sample_dataframe):
        ...
        with patch('app.models.user_data.UserData.find_one', new_callable=AsyncMock) as mock_find:
            ...
            with patch('app.services.s3_service.s3_service.download_file_bytes', new_callable=AsyncMock) as mock_s3_download:
                ...
                response = await async_test_client.get("/api/v1/data/test-file-123/preview?limit=3")
    ...
    @pytest.mark.asyncio
    async def test_export_data_csv(self, async_test_client: AsyncClient, setup_database, sample_dataframe):
    ...
    @pytest.mark.asyncio
    async def test_process_dataset_with_invalid_file(self, async_test_client: AsyncClient, setup_database):
        ...
        with patch('app.models.user_data.UserData.find_one', new_callable=AsyncMock) as mock_find:
            ...
            with patch('app.services.s3_service.s3_service.download_file_bytes', new_callable=AsyncMock) as mock_s3_download:
                ...
                mock_s3.side_effect = Exception("Failed to retrieve file")
