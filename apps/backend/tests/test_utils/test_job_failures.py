...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ValueError("The least populated class in y has only 1 member"), "only one distinct value"),
        (ValueError("n_splits=5 cannot be greater than the number of members in each class"), "too few rows"),
